define(function(require){
    ...
    const {calculatePercent, formatNumber} = require('./helpers/common');
    ...
    return function module() {
        ...
        function cleanData(data) {
            ...
            return data.map((d) => {
                let percentage = calculatePercent(d[quantityLabel], totalQuantity);

                d.quantity = +d[quantityLabel];
                d.name = String(d[nameLabel]);
                d.percentage = String(d.percentage || formatNumber(percentage, '.1f'));
